...
public class View extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setFont(new java.awt.Font("游ゴシック", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("バッテリー登録情報");

        jScrollPane1.setBorder(null);

        jTable1.setBackground(new java.awt.Color(40, 44, 52));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "バッテリー番号", "バッテリー製造日", "材料番号", "車両番号", "車両製造日", "走行可能距離１", "総容量,内部抵抗１"
            }
        ) {
        ...
        jTable1.setSelectionBackground(new java.awt.Color(36, 52, 60));
        ...
        jScrollPane2.setBackground(new java.awt.Color(40, 44, 52));
        jScrollPane2.setBorder(null);
        jScrollPane2.setForeground(new java.awt.Color(255, 255, 255));

        jTextPane1.setBackground(new java.awt.Color(40, 44, 52));
        jTextPane1.setBorder(null);
        jTextPane1.setFont(new java.awt.Font("游ゴシック Medium", 0, 12)); // NOI18N
        jTextPane1.setForeground(new java.awt.Color(255, 255, 255));
        jTextPane1.setText("BN---バッテリー番号　　　　 　 BPD---バッテリー製造日\nBCN---材料番号　　　　　　　　CN---車両番号\nCPD---車両製造日　　　　　　　RNG1---航続可能距離１\nAHRHX---総容量,内部抵抗値１");
